...
public class BotConfiguration implements CommandLineRunner
{
    ...
    private void registerCommands(GatewayDiscordClient client)
    {
        ...
        ApplicationCommandRequest nextWeekRequest = addAltOptions(ApplicationCommandRequest.builder()
            .name("next_week")
            .description("Gets recs for next week, with optional restrictions"))
            .build();
        commands.add(nextWeekRequest);

        ApplicationCommandRequest peakRequest = ApplicationCommandRequest.builder()
                .name("peak")
                .description("Displays what cycle a craft will peak in the current season")
                .addOption(ApplicationCommandOptionData.builder()
                        .name("craft1")
        ...
        ApplicationCommandRequest thisWeekRequest = addAltOptions(ApplicationCommandRequest.builder()
                .name("this_week")
                .description("Gets recs for the rest of the week with extra restrictions"))
                .build();
        ...
        ApplicationCommandRequest todayRequest = ApplicationCommandRequest.builder()
                ...
                .addOption(ApplicationCommandOptionData.builder()
                        ...
                        .type(ApplicationCommandOption.Type.INTEGER.ordinal())
                        .required(false)
                        .build())
                .build();
        commands.add(todayRequest);

        ApplicationCommandRequest altsRequest = addAltOptions(ApplicationCommandRequest.builder()
                .name("alts")
                .description("Gets recs for the rest of the week with extra restrictions"))
                .build();
    ...
    private ImmutableApplicationCommandRequest.Builder addAltOptions(ImmutableApplicationCommandRequest.Builder builder)
    {
        return builder.addOption(ApplicationCommandOptionData.builder()
            ...
            .addOption(ApplicationCommandOptionData.builder()
                    ...
                    .type(ApplicationCommandOption.Type.BOOLEAN.ordinal())
                    .required(false)
            ...
            .addOption(ApplicationCommandOptionData.builder()
                    .name("force_rest")
                    .description("Enter a cycle for your second rest. Leave out to let the bot pick the best cycle.")
                    .type(ApplicationCommandOption.Type.INTEGER.ordinal())
                    .required(false)
                    .addChoice(ApplicationCommandOptionChoiceData.builder().name("C2").value(1).build())
                    .addChoice(ApplicationCommandOptionChoiceData.builder().name("C3").value(2).build())
                    .addChoice(ApplicationCommandOptionChoiceData.builder().name("C4").value(3).build())
                    .addChoice(ApplicationCommandOptionChoiceData.builder().name("C5").value(4).build())
                    .addChoice(ApplicationCommandOptionChoiceData.builder().name("C6").value(5).build())
                    .addChoice(ApplicationCommandOptionChoiceData.builder().name("C7").value(6).build())
                    .build());
    }
